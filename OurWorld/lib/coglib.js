...
const Forest = require('tiny-forest');

// This literally only exists so that a promise timeouts to null does not get confused with a regular function that happens to also return null.
class Timeout { }
